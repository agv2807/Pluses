package com.example.pluses.task_list.edit_item_menu
...
class EditItemFragment(val text: String = "", val position: Int) : Fragment() {
    ...
    private fun setupViews(view: View) {
        ...
        cancelButton?.setOnClickListener {
            ...
            mainActivity.taskListFragment.closeEditMenu()
        ...
        saveButton?.setOnClickListener {
            if (newTaskEditText?.text!!.isNotEmpty()) {
                ...
                mainActivity.taskListFragment.taskListAdapter.reloadItem(item = Task(newTaskEditText?.text.toString()), position = position)
